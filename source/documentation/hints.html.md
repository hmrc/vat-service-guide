...
This section contains guidance about how to integrate your software with the [VAT Assist (MTD) API](/api-documentation/docs/api/service/mtd-transaction-risking), which will be available from April 2027.
